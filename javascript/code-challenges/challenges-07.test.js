...
the characters in the starWarsPeople array by height 
...
Write a function named joinArray that
 takes an array and joins all of the
...
Write a function name wordsToCharList that, given 
a string as input, returns a new array where every 
element is a character of the input string.

For example, wordsToCharList('gregor') returns 
['g','r','e','g','o','r'].
------------------------------------------------------------------------------------------------ */
...
Write a function named listFoods that takes in the recipe
 and returns a new array of the food items without any 
 amount or units. Just the name. For example, 
...
const listFoods = (recipe) => {
  ...
  for (let i = 0; i < recipe.ingredients.length; i++) {
    let word=recipe.ingredients[i];
    let word1=word.slice(word.indexOf(" ")+1);
    let word2=word1.slice(word1.indexOf(" ")+1);
    result.push(word2);
  }
  return result;
};
