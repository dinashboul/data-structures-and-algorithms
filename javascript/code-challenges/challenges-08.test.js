...
Write a function named containsW that 
takes in a string. This function should use
 a regular expression pattern to return true if
  the string contains the letter 'w' in lower case or 
...
const citiesAtoJ = (arr) => {
  // Solution code here...
  let newArray = arr.filter(item =>/^[A-J]/.test(item));
  return newArray;
};
