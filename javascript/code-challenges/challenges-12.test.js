...
Write a function named replaceZeros that,
 given a string, uses Regex to replace all '0' with the 
 word 'zero'.
------------------------------------------------------------------------------------------------ */
...
Write a function named validatePin that uses a
 regular expression pattern to validate a PIN.

If the PIN is four numerical digits long, 
...
Write a function named validateWord that uses a
 regular expression pattern to validate that a word is 
...
const validateWord = (word) => {
  // Solution code here...
  let regix= /^[a-zA-Z]{5,10}$/;
  return regix.test(word);
};

/* ------------------------------------------------------------------------------------------------
CHALLENGE 4

Write a function named hasNumber that uses a regular 
expression pattern to determine if a string has one or
 more letter followed by one or more digit.
